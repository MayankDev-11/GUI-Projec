...
root.iconbitmap(r"C:\Users\Mayank\OneDrive\Documents\Python\Python projects\Images\ruler.ico")
root.resizable(0,0)
...
equal_label = tkinter.Label(root,text = "=",bg = "#c75c5c",font = field_font)
...
convert_button = tkinter.Button(root,command = convert,text = "Convert",font=field_font,bg = button_color)
